  ...
  <body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
                ...
                <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                  ...
                  <span class="hidden-xs">
                    <?php 
                      ...
                      echo(($resultado->first_row()->nombre) . ' ' . ($resultado->first_row()->apellido));
                     ?>
                  </span>
                </a>
                <ul class="dropdown-menu">
                  ...
                  <li class="user-footer">
                    <div class="pull-left">
                      <a id="desaparecer" href="#" class="btn btn-default btn-flat">Profile</a>
                    </div>
                    <div class="pull-right">
                      <a href="<?php echo (site_url('login/logout')); ?>" class="btn btn-default btn-flat">Desconectarse</a>
                    </div>
                  </li>
                </ul>
              </li>
      ...
      <div class="content-wrapper">
        ...
        <section class="content-header-generic">
          <h1>
            Dashboard
        ...
        <section id="profile-title" class="">
          PERFIL-TITULO
        </section>
        <section  id="profile-content" class="">
          PERFIL-CONTENIDO
        </section>
        </section><!-- /.content -->
      </div><!-- /.content-wrapper -->
    ...
    <script>
      $( "#desaparecer" ).click(function() {
        console.log('Hola');
        $('.content-header').hide(1000);
        $('.content').hide(1000);
        setTimeout(function(){
          console.log('terminó la animacion');
      ...
      $(document).ready(function() {
        $('section[id^="profile-"]').hide();
        $('.content-header-generic').hide();
        $('.content-generic').hide();
